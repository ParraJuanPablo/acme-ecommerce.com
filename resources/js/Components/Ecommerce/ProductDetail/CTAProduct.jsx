                ...
                <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
                    ...
                    <div className="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <form className="mt-10">
                            <div
                                class="py-2 px-3 bg-white border border-gray-200 rounded-lg dark:bg-slate-900 dark:border-gray-700"
                            ...
                            <PrimaryButton 
                            type="submit"
                            className="mt-10 flex w-full items-center justify-center px-8 py-3 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                                {" "}
                                Add to Bag{" "}
                            </PrimaryButton>
                        </form>
